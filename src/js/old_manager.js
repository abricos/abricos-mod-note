...
Component.entryPoint = function(NS){
    ...
    RecordWidget.prototype = {
        ...
        onClick: function(el){
            if (!L.isNull(this._activeEditor) && this._activeEditor.onClick(el)){
                return true;
            }
    ...
    NoteListWidget.prototype = {
        ...
        onClick: function(el){
            ...
            switch (prefix) {
                case (TId['noterow']['bedit'] + '-'):
                    this.editNote(numid);
                    return true;
                case (TId['noterow']['bremove'] + '-'):
                    this.removeNote(numid);
                    return true;
                case (TId['notetl']['bsel'] + '-'):
                    this.selectNote(numid);
                    return true;
            }
    ...
    NotepadWidget.prototype = {
        ...
        onClick: function(el){
            if (this.notesWidget.onClick(el)){
                return true;
            }
            if (this.recordsWidget.onClick(el)){
                return true;
            }
            return false;
        },
